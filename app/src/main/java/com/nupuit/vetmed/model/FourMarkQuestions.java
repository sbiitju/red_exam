...
public class FourMarkQuestions extends RealmObject{

    public FourMarkQuestions(){}

    String qsn, op1, op2, op3, op4, correctAns, explaination, qsnNumber, mark;

    public FourMarkQuestions(String qsn, String op1, String op2, String op3, String op4, String correctAns, String explaination, String qsnNumber, String mark) {
        this.qsn = qsn;
        this.op1 = op1;
        this.op2 = op2;
        this.op3 = op3;
