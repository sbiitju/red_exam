...
public class FourMarkQuestion_New extends RealmObject {
...
//    String qsnNumber;
    ...
    public FourMarkQuestion_New(String qsn1, String qsn1OPa, String qsn1OPb, String qsn1OPc,
                                ...
                                RealmList<RealmString> qsn2Op, RealmList<RealmString> mainOptions,
                                String qsnNumber, String mark) {
        this.qsn1 = qsn1;
    ...
    public void setQsn2Op(RealmList<RealmString> qsn2Op) {
        this.qsn2Op = qsn2Op;
    }
    ...
    public void setMainOptions(RealmList<RealmString> mainOptions) {
        this.mainOptions = mainOptions;
    }
